...
### 5.6.2 韩俊柠-16340068
> 这次项目开发过程，遇到了很多“麻烦”的问题，最后发现其实就是设备出现了问题。至于代码由于有大佬的存在，在完成的测试后，出现了一些功能和我们预想
的不一样的问题，但是都轻松解决。在将执行文件传输到设备系统上时，由于权限设置让我们花费了较多时间。总而言之，这次实验让我更多的了解到了内核以及文件系统的相关知识，会有许多小问题，但是都解决得很快。
### 5.6.3 
